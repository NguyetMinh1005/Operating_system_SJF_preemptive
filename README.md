...
_Bước 2_: Mở VS Code, tạo file **process.py** và bắt đầu viết code.

_Bước 3_: Sau khi code xong (hoặc xong một phần muốn lưu lại), gõ lần lượt 3 lệnh sau để đẩy code lên GitHub:
git add .
...
_Bước 2_: Mở VS Code, tạo các file cần thiết và bắt đầu viết code.

_Bước 3_: Sau khi test xong, gõ lần lượt 3 lệnh sau để đẩy code lên GitHub:
git add .
